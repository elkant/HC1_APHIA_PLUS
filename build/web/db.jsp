...
<html>
    ...
    <body>
        <div id="container" style="height:620px;">
            ...
            <div id="header">
                <div class="ui-widget" style="width:1160px;margin-left: -50px;" >
            ...
            <div id="content" style="height:500px;margin-left:160px; overflow:hidden ;">
                ...
                <form action="updatedbpword" method="post" style="margin-left: 100px; height:340px; width:540px;">
                    ...
                    <table style="margin-left:120px;width:300px;"   cellpadding="8px" cellspacing="6px">
                        ...
                        <tr> <td style="text-align: right;">Database : <img src="images/blguide.png" title="enter the database name e.g masterhc" /></td>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><input type="submit" style="width: 100px;height:30px; background-color: orange;" value="Save"/>
            ...
            <div id="footer">
                ...
                %>
                <p align="center"> &copy <a href="#" title="">HC</a> Aphia Plus | USAID <%=year%></p>
            </div>
        </div>
    </body>
