<%-- 
    Document   : district_bar_chart
    Created on : Oct 9, 2013, 11:19:27 AM
    Author     : Geofrey yabuto
--%>
<%-- 
    Document   : county_pie_chart2
    Created on : Sep 23, 2013, 9:23:51 AM
...
<html>
    <head>
        ...
        <title>District pie chart</title>
 ...
 <%}%>
            ...
            <div id="content">
                ...
                <div id="midcontent">
                    ...
                    <iframe width="950px" style="margin-left:25px;" height="650px"  src="district_pie_chart"></iframe>
