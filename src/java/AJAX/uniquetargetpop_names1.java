 ...
 * @author SIXTYFOURBIT
 */
public class uniquetargetpop_names1 extends HttpServlet {
  ...
  HttpSession session;
    ...
    String partner_id="";        
        ...
        //   System.out.println(" County:"+ county_name); 
           ...
           String districts="Select distinct(population_name) from target_population ";
         ...
         //dist arraylist stays in the session
          ...
          // response.sendRedirect("myajax.html");
            ...
            Logger.getLogger(uniquetargetpop_names.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
