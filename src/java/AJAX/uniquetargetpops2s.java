 ...
 * @author SIXTYFOURBIT
 */
public class uniquetargetpops2s extends HttpServlet {
...
//                                               }  
    String partner_id="";        
        ...
        //   System.out.println(" County:"+ county_name); 
           ...
           String districts="Select distinct(population_name) from groups left join target_population on groups.target_pop_id=target_population.target_id left join member_details on groups.group_id=member_details.group_id where year='"+year+"'";
         ...
         //dist arraylist stays in the session
          ...
          if(conn.rs.getString("population_name").equals("FEMALES (15 to 24)")){
          
           currentgroups=currentgroups+"<option selected value=\""+conn.rs.getString(1)+"\">"+conn.rs.getString("population_name")+"</option>";
