 ...
 * @author SIXTYFOURBIT
 */
public class MandEmerge extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //tempdbConn conn = new tempdbConn();
             dbConn conn= new dbConn();//hc normal db
            dbConn1 conn1 = new dbConn1();//masterhc table
            ...
            while (conn.rs.next()) {
                ...
                if (conn1.rs1.next()) {
                    ...
                    if(!conn1.rs1.getTimestamp("timestamp").toString().equals(conn.rs.getTimestamp("timestamp").toString())){
                        ...
                        String upd="update groups set group_name='"+conn.rs.getString(2)+"',partner_id='"+conn.rs.getString(3)+"',target_pop_id='"+conn.rs.getString(4)+"',district_id='"+conn.rs.getString(5)+"',timestamp='"+conn.rs.getTimestamp(6)+"' ,wardid='"+conn.rs.getTimestamp(7)+"' where group_id='"+conn.rs.getString(1)+"' ";
...
//============================================================================
            ...
            response.sendRedirect("NetBackUp");
