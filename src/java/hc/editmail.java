...
public class editmail extends HttpServlet {
    ...
    if(conn.st.executeUpdate("update mande_mail set mail='"+mail+"' , county='"+county+"',partner='"+partner+"' , usermail='"+usermail+"' where mailid='1'")==1){
    
        
       
    session.setAttribute("mailchanged", "<h3><font color=\"green\">Details changed successfully. You may now proceed with data entry by Clicking <b>HC Form Entry</b> on the menu.  </font></h3>");     
    }
    else{
