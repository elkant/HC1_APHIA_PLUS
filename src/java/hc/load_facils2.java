 ...
 */
public class load_facils2 extends HttpServlet {
String current_curs;
  HttpSession session;
...
System.out.println("in java");
              current_curs="<option value=\"\">Choose co-Facilitator</option>";
             ...
             System.out.println(conn.rs.getString("facilitator_id"));      
              current_curs=current_curs+"<option value=\""+conn.rs.getString("facilitator_id")+"\">"+conn.rs.getString("first_name")+" "+conn.rs.getString("middle_name")+" "+conn.rs.getString("sur_name")+" ( "+conn.rs.getString("phone")+" ) </option>";
               ...
               if(current_curs.equals("<option value=\"\">Choose co-Facilitator</option>")){
               current_curs="<option value=\"_\">No added co-facilitators </option>";
               }
