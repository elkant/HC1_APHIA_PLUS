 ...
 * @author SIXTYFOURBIT
 */
public class population_chooser1 extends HttpServlet {
        ...
        //   System.out.println(" County:"+ county_name); 
         ...
         //dist arraylist stays in the session
          ...
          //dynamically add districts to the string array
               ...
               if(conn.rs.getString("target_id").equals(session.getAttribute("targetid"))){
          currentgroups=currentgroups+"<option selected value=\""+conn.rs.getString("target_id")+"\">"+conn.rs.getString("population_name")+"</option>";
               }
               else {
