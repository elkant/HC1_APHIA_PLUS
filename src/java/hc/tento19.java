 ...
 */
public class tento19 extends HttpServlet {
HttpSession session;
    ...
    for(int pe=1;pe<=4;pe++){
     ...
     while(conn.rs1.next()){
         ...
         while(conn.rs3.next()){
             ...
             if(max_lessons>0){
             String member_selector="select * from member_details where sessions_attended>='"+max_lessons+"'  and age>=15 and age<=24 and group_id='"+conn.rs3.getString(1) +"' && year='"+yea+"' && period='"+pe+"' and month='"+6+"' ";
...
//     
     ...
     rw0cell0.setCellValue("GIRLS 10 to 19 "+yea);
  ...
  //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     ...
     while(conn.rs2.next()){
       ...
       while(conn.rs3.next()){
           ...
           String member_selector="select * from member_details where sessions_attended>='"+max_lessons+"' and age>=15 and age<=24  and  group_id='"+group_id+"'&& year='"+yea+"' && period='"+pe+"' and month='"+6+"' ";
           
           System.out.print(member_selector);
...
response.setHeader("Content-Disposition", "attachment; filename=HC_MONTHLY_REPORT_"+date1+".xls");
...
outStream.flush();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(tento19.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
