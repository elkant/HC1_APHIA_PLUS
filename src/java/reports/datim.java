 ...
 * @author Manuel
 */
public class datim extends HttpServlet {
...
String pathtodelete=null;
 ...
 String allpath = getServletContext().getRealPath("/datim_noage.xlsm");
...
String dat2 = da.toString().replace(" ", "_");
 dat2 = dat2.toString().replace(":", "_");
    ...
    String np=mydrive+":\\APHIAPLUS\\HC_SYSTEM\\MACROS\\datim_non_s2s_"+dat2+".xlsm";
    //check if file exists
     String sourcepath = getServletContext().getRealPath("/datim_noage.xlsm");
...
System.out.println("excel file now open");
   String columnheaders[]={"PARTICIPANT","SEX","QUARTER","PARTNER","TARGET_POPULATION","YEAR","COUNTY","SUB_COUNTY","WARD"};
        
  //  PARTICIPANT	SEX	AGE_BRACKET	PARTNER	TARGET_POPULATION	MONTHS	YEAR	COUNTY

    XSSFSheet rawdata = wb.getSheet("datim_noage");
...
+" group by  COUNTY,PARTNER,TARGET_POPULATION,QUARTER,SEX,WARD"
    ...
    System.out.println(qry);
      ...
      System.out.println("==================" + conn.rs.getString(1) + "_" + conn.rs.getString(2) + " _ " + conn.rs.getString(3) + " _ " + conn.rs.getString(4) + " _ " + conn.rs.getString(5) + " _ " + conn.rs.getString(6));
           ...
           // cell4.setCellStyle(innerdata_style);
            ...
            cell6.setCellValue(conn.rs.getInt(6));
         ...
         //Year
          ...
          //  cell7.setCellStyle(innerdata_style);
            ...
            if(conn.rs.getString(9)!=null){ward=conn.rs.getString(9);}
            XSSFCell cell9 = rw2.createCell(8);
            cell9.setCellValue(ward);
          //  cell7.setCellStyle(innerdata_style); 
        ...
        response.setHeader("Content-Disposition", "attachment; filename=datim_format_report" + dat1 + ".xlsm");
