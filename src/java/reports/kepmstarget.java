 ...
 */
public class kepmstarget extends HttpServlet {
HttpSession session;
...
String kepms_name,kepms_id="";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("_______________Servlet is kepmstarget.java________________");
        String period,yea;
...
//                 System.out.println("here 222");
   ...
   //================MALE TARGETS   
        ...
        //==FEMALE TARGETS
          posit++;
        if(report2_m>0){
        String qr="select target from targets where countyid='"+countyid+"' and partnerid='"+partnersid.get(z) +"' and sex='male' and year='"+year+"'";
     ...
     posit++;
       ...
       HSSFCell q4cell= rwaa.createCell(posit);        
        ...
        HSSFCell achievedcell= rwaa.createCell(posit);        
         posit++;
        if(report2_m>0){ achievedcell.setCellValue(((report2_m/curtarget)*100)+"%");}
...
targetposcopy=targetpos;               
       ...
       HSSFCell countycell= rwaa.createCell(posit);        
        ...
        posit++;
          if(report2_f>0){
         String qr="select target from targets where countyid='"+countyid+"' and partnerid='"+partnersid.get(z) +"' and sex='female' and year='"+year+"'";
       ...
       HSSFCell ttlcell= rwaa.createCell(posit);        
        ...
        HSSFCell achievedcell= rwaa.createCell(posit);        
         posit++;
        if(report2_f>0){ achievedcell.setCellValue(((report2_f/curtarget)*100)+"%");}
       else { achievedcell.setCellValue(""); } 
        achievedcell.setCellStyle(innerdata_style); 
