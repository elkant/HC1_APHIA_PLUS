 ...
 * @author Manuel
 */
public class partnerbasedkepms extends HttpServlet {
...
String pathtodelete=null;
 ...
 String allpath = getServletContext().getRealPath("/Partnerbasedkepms.xlsm");
...
String dat2 = da.toString().replace(" ", "_");
 dat2 = dat2.toString().replace(":", "_");
    ...
    String np=mydrive+":\\APHIAPLUS\\HC_SYSTEM\\MACROS\\Partnerbasedkepms"+dat2+".xlsm";
    //check if file exists
     String sourcepath = getServletContext().getRealPath("/Partnerbasedkepms.xlsm");
...
System.out.println("excel file now open");
   String columnheaders[]={"PARTICIPANT","SEX","PARTNER","TARGET_POPULATION","MONTHS","YEAR","COUNTY"};
...
+" group by COUNTY,PARTNER,TARGET_POPULATION,MONTHS,SEX"
+" order by  PARTNER,TARGET_POPULATION,SEX DESC";
    ...
    System.out.println(qry);
      ...
      System.out.println("==================" + conn.rs.getString(1) + "_" + conn.rs.getString(2) + " _ " + conn.rs.getString(3) + " _ " + conn.rs.getString(4) + " _ " + conn.rs.getString(5) + " _ " + conn.rs.getString(6));
        ...
        response.setHeader("Content-Disposition", "attachment; filename=kepms_format_partners_report" + dat1 + ".xlsm");
