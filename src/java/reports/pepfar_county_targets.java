 ...
 */
public class pepfar_county_targets extends HttpServlet {
HttpSession session;
   ...
   String partner_name,tag_name_p;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      HSSFWorkbook wb =null;
            ...
            System.out.println("_______________Servlet is pepfar_county_targets.java________________");
            String period,yea;
    //            yea=session.getAttribute("year").toString();
         ...
         System.out.println(allpath);
            ...
            wb = new HSSFWorkbook( );
      System.out.println("generating Pepfar Report");      
    ...
    //     int report2_conc=0;
        ...
        int ps=1;
         ...
         rws.setHeightInPoints(30);
          ...
          String headers[]={"County","IP","Target Grouped","Sex","County Target","Oct-Dec ("+prev_yea+")","Jan-Mar ("+yea+")","Apr-Jun ("+yea+")","Jul-Sep ("+yea+")","Total","Achieved"};
          
            
             for(int a=0;a<headers.length;a++){
             HSSFCell rwx=rws.createCell(ps);
              rwx.setCellValue(headers[a]);
             rwx.setCellStyle(style);
             ps++;
             }
    //     a+=1;
    ...
    +" and SEX !='' and  sessions_attended >0 and sessions_attended=no_of_lessons and year ='"+year+"' group by COUNTY,PARTNER,TARGET_POPULATION,SEX, QUARTER order by  COUNTY,PARTNER,TARGET_POPULATION ,SEX DESC,QUARTER ASC ";
     ...
     shet2.addMergedRegion(new CellRangeAddress(countyposcopy, countypos-1, 6, 6));
    ...
    //===================================================================row is created at this point          
       ...
       //================MALE TARGETS   
            ...
            String qr="select sum(target) as target from targets where countyid='"+COUNTY_ID+"'   and year='"+year+"'";
    ...
    //===================================================================row is created at this point          
           ...
           HSSFCell countycell= rwaa.createCell(posit);        
            ...
            posit++;
             ...
             String qr="select sum(target) as targets from targets where countyid='"+COUNTY_ID+"'  and year='"+year+"'";
    ...
    response.setHeader("Content-Disposition", "attachment; filename=HC_PEPFAR_For_"+year+"_Generated_on_"+date1+".xls");
